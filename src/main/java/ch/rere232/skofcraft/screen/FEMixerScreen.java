...
public class FEMixerScreen extends AbstractContainerScreen<FEMixerMenu> {
    ...
    public FEMixerScreen(FEMixerMenu menu, Inventory inventory, net.minecraft.network.chat.Component component) {
    ...
    public void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        FEMixerBlockEntity blockEntity = menu.getBlockEntity();
